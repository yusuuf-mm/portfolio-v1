...
export const projects: Project[] = [
  {
    ...
    highlights: [
      ...
      'ETL pipelines via Airflow + AWS Glue for energy data ingestion at scale',
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      'OpenAPI contract-first design keeping frontend TypeScript types in perfect sync',
  ...
  },
  {
    ...
    highlights: [
      ...
      'DynamoDB-backed distributed rate limiting and prediction logging',
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      'Automated data processing pipeline for financial reporting accuracy',
      'Secure REST API design with seamless frontend integration',
    ],
    github: null,
    demo: null,
    featured: false,
