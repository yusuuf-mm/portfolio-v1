...
function OrchestrationScene() {
  ...
  useFrame(({ clock }) => {
    ...
    if (edgeGeomRef.current) {
      const posArray = edgeGeomRef.current.attributes.position.array as Float32Array
      ...
      edgeGeomRef.current.attributes.position.needsUpdate = true
    }
